---
title: "Obtain the block content in group announcement"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/chat-announcement-block/get"
method: "GET"
api_path: "https://open.larksuite.com/open-apis/docx/v1/chats/:chat_id/announcement/blocks/:block_id"
service: "docx-v1"
...
updated: "1739935029000"
---

# Obtain the block content in group announcement

Obtains the rich text content of the specified block.
...
| `block_id` | `string` | The unique identifier of the block. You can use the Obtain all blocks of a group announcement to get the `block_id`. **Example value**: "doxcnO6UW6wAw2qIcYf4hZabcef" | ### Query parameters
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
...
|       `url_type` | `string` | Link type **Optional values are**:  - `MessageLink`: Message link - `Undefined`: Undefined link type  | ### Response body example
