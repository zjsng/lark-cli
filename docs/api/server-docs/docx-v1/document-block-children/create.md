---
title: "Create Block"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/document-docx/docx-v1/document-block-children/create"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/docx/v1/documents/:document_id/blocks/:block_id/children"
service: "docx-v1"
...
| `block_id` | `string` | `block_id` of the parent block, indicating that a number of child blocks have been created for it. If you need to create a child block for the root node of the document tree, you can fill in `document_id` here. **Example value**: "doxcnO6UW6wAw2qIcYf4hZpFIth" | ### Query parameters
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `children` | `block[]` | No | Add a list of children. **Data validation rules**: - Length range: `1` ～ `50` |
...
|     `background_color` | `int` | No | Callout block background color **Example value**: 1 **Optional values are**:  - `1`: Light red - `2`: Light orange - `3`: Light yellow - `4`: Light green - `5`: Light blue - `6`: Light purple - `7`: Light neutral - `8`: Dark red - `9`: Dark orange - `10`: Dark yellow - `11`: Dark green - `12`: Dark blue - `13`: Dark purple - `14`: Dark neutral - `15`: Dark slight gray  |
|     `border_color` | `int` | No | Border color **Example value**: 1 **Optional values are**:  - `1`: Red - `2`: Orange - `3`: Yellow - `4`: Green - `5`: Blue - `6`: Purple - `7`: Neutral  |
...
|       `iframe_type` | `int` | No | Iframe Type **Example value**: 1 **Optional values are**:  - `1`: Bilibili - `2`: Xigua Video - `3`: Youku - `4`: Airtable - `5`: Baidu Map - `6`: Autonavi Map - `7`: TikTok - `8`: Figma - `9`: Ink knife - `10`: Canva - `11`: CodePen - `12`: Lark Survey - `13`: Gold data - `14`: Google Map - `15`: Youtube - `99`: Other  |
...
|       `row_size` | `int` | Yes | Number of rows **Example value**: 1 **Data validation rules**: - Value range: `1` ～ `9` |
|       `column_size` | `int` | Yes | Number of columns **Example value**: 1 **Data validation rules**: - Value range: `1` ～ `9` |
...
| `index` | `int` | No | Created child blocks will be inserted into the specified block children list at the index position. The starting value of index is 0, and the maximum value is the length of the children of the specified block. When index is -1, created child blocks will be inserted at the end of the list. **Example value**: 0 **Default value**: `-1` | ### Request body example
...
| `data` | `\-` | \- |
|   `children` | `block[]` | Block information for children added |
...
|   `document_revision_id` | `int` | The version number of the document after the current block children is successfully created |
