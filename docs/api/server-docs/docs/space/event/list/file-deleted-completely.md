---
title: "File deleted completely"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/event/file-deleted-completely"
section: "Docs"
scopes:
  - "drive:drive"
  - "docs:doc"
...
updated: "1768985237000"
---

# Permanently delete a file
When a subscribed file is permanently deleted, this event is triggered. 
...
| Facts |  |
| --- | --- |
| Event type | drive.file.deleted_v1 |
...
```json
{
    ...
    "header": {
        ...
        "event_type": "drive.file.deleted_v1",  // Type of the event
