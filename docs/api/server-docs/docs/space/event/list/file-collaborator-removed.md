---
title: "File collaborator removed"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/event/file-collaborator-remove"
section: "Docs"
scopes:
  - "drive:drive"
  - "docs:doc"
...
updated: "1768985197000"
---

# Remove a file collaborator
This event is triggered when a user or group is removed as a collaborator to a file. 
...
| Facts |  |
| --- | --- |
| Event type | drive.file.permission_member_removed_v1 |
...
| `event` | `\-` | \- |
|   `chat_list` | `list` | List of removed group IDs |
...
|   `user_list` | `list` | List of removed user IDs |
|     `union_id` | `string` | User's Union ID |
|     `user_id` | `string` | User's User ID **Field Permission Requirement**: `contact:user.employee_id:readonly` |
...
```json
{
  ...
  "header": {
    ...
    "event_type": "drive.file.permission_member_removed_v1", // Event type
