---
title: "Get Document Comments in Pages"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-comment/list"
method: "GET"
api_path: "https://open.larksuite.com/open-apis/drive/v1/files/:file_token/comments"
service: "drive-v1"
...
| --- | --- | --- |
| `file_token` | `string` | Token of the document **Example value**: "doccnHh7U87HOFpii5u5Gabcef" | ### Query parameters
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `file_type` | `string` | Yes | Type of the document **Example value**: doc **Optional values are**:  - `doc`: Doc - `sheet`: Sheet - `file`: File in My Space - `docx`: Upgraded Docs  |
| `is_whole` | `boolean` | No | Whether whole comment **Example value**: False |
| `is_solved` | `boolean` | No | Specifies whether the comment is solved. This field is optional. **Example value**: false |
| `page_token` | `string` | No | Page identifier. It is not filled in the first request, indicating traversal from the beginning; when there will be more groups, the new page_token will be returned at the same time, and the next traversal can use the page_token to get more groups **Example value**: 6916106822734512356 |
...
|   `items` | `file.comment[]` | Comment list |
        ...
        "items": [
            {
                ...
                "page_token": "6916106822734512356",
                "is_whole": true,
                "quote": "Comment quotation content",
                "reply_list": {
                    "replies": [
                        {
