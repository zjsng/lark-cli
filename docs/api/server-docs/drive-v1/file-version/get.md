...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/file-version/get"
method: "GET"
...
| --- | --- | --- |
| `file_token` | `string` | document token **Example value**: "shtbcqqoXZJaKYrfN5IHQg4sVFZ" |
