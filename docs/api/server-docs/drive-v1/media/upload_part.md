---
title: "Multipart Upload Media (Upload)"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/media/upload_part"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/drive/v1/medias/upload_part"
service: "drive-v1"
resource: "media"
section: "Docs"
scopes:
...
| `seq` | `int` | Yes | **Example value**: |
| `size` | `int` | Yes | **Example value**: |
