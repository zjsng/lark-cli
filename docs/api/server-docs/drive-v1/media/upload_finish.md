---
title: "Multipart Upload Media (Finish)"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/media/upload_finish"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/drive/v1/medias/upload_finish"
service: "drive-v1"
resource: "media"
section: "Docs"
scopes:
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `upload_id` | `string` | Yes | **Example value**: "" |
| `block_num` | `int` | Yes | **Example value**: | ### Request body example
