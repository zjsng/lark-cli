...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/meeting_room-v1/meeting_room/events/updated"
...
It will be triggered when the meeting room is updated.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=meeting_room&version=v1&resource=meeting_room&event=updated)
...
| Facts |  |
| --- | --- |
| Event type | meeting_room.meeting_room.updated_v1 |
