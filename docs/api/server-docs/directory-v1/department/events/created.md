...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/directory-v1/department/events/created"
...
To receive the event notification when a new department is created. 
...
{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=directory&version=v1&resource=department&event=created)

## Event
| Facts |  |
| --- | --- |
| Event type | directory.department.created_v1 |
