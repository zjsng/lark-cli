---
title: "Employee resurrected"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/directory-v1/employee/events/resurrect"
...
To receive the event notification when an employee cancelled the resignation. 
...
{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=directory&version=v1&resource=employee&event=resurrect)

## Event
| Facts |  |
| --- | --- |
| Event type | directory.employee.resurrect_v1 |
