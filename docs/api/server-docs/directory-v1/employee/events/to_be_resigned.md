---
title: "Employee to be resigned"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/directory-v1/employee/events/to_be_resigned"
...
To receive the event notification when an employee is set to resign. 
...
{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=directory&version=v1&resource=employee&event=to_be_resigned)

## Event
| Facts |  |
| --- | --- |
| Event type | directory.employee.to_be_resigned_v1 |
