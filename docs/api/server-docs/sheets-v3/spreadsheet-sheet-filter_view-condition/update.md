...
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter_view-condition/update"
method: "PUT"
...
::: note
For filter condition parameters, see User guide for using filter conditions in the filter view
...
| `condition_id` | `string` | Column letter designation **Example value**: "E" | ### Request body
