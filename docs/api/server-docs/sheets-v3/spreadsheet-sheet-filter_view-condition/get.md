---
title: "Obtain Filter Condition"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter_view-condition/get"
method: "GET"
...
| `condition_id` | `string` | Letter designation of column for which to query filter conditions **Example value**: "E" | ```
