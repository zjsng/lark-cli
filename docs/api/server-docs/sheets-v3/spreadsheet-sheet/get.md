---
title: "Query sheet"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet/get"
method: "GET"
api_path: "https://open.larksuite.com/open-apis/sheets/v3/spreadsheets/:spreadsheet_token/sheets/:sheet_id"
service: "sheets-v3"
...
updated: "1710130589000"
---

# Query sheet

This interface is used to query worksheet attribute information by worksheet ID.
...
| --- | --- | --- |
| `spreadsheet_token` | `string` | Spreadsheet token, how to get related cloud document resources **Example value**: "xxxxxxxxxxxxxxxxxx" |
| `sheet_id` | `string` | The id of the worksheet **Example value**: "giDk9k" | ### Request example 
```bash 
