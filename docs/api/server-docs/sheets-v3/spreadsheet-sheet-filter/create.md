---
title: "Create Filter"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/sheets-v3/spreadsheet-sheet-filter/create"
method: "POST"
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `range` | `string` | Yes | Range **Example value**: "xxxxxx!C1:H14" |
| `col` | `string` | Yes | Column with set filter conditions **Example value**: "E" |
