...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/moments-v1/comment/events/created"
service: "moments-v1"
resource: "comment"
section: "Moments"
scopes:
...
updated: "1760520784000"
---

# Comment posted

Event triggered when a comment is posted.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=moments&version=v1&resource=comment&event=created)

## Event
| Facts |  |
| --- | --- |
| Event type | moments.comment.created_v1 |
...
|   `reply_comment_id` | `string` | Reply to Comment ID |
|   `root_comment_id` | `string` | Root Comment ID |
|   `user_type` | `int` | Comment user type **Optional values are**:  - `1`: Real name - `2`: Nickname - `3`: Anonymous - `4`: official account  | ### Event body example
