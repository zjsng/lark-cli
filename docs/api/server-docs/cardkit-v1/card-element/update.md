...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/cardkit-v1/card-element/update"
method: "PUT"
...
| `element` | `string` | Yes | new component **Example value**: "{\"tag\":\"markdown\",\"id\":\"md_1\",\"content\":\"普通文本\"}" **Data validation rules**: - Length range: `1` ～ `1000000` characters |
...
#### Error Codes
      ...
      Failed to replace component. Please check the input parameters according to the error information returned by the interface.
