---
title: "Patch Update Element"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/cardkit-v1/card-element/patch"
method: "PATCH"
api_path: "https://open.larksuite.com/open-apis/cardkit/v1/cards/:card_id/elements/:element_id"
service: "cardkit-v1"
...
This interface does not support modifying the tag attribute of a component.
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `partial_element` | `string` | Yes | The configuration content of the component part to be changed will be updated after passing the id parameter to the original component. Modifying the tag parameter is not supported. **Example value**: "{\"content\":\"Updated text\"}" **Data validation rules**: - Length range: `1` ～ `1000000` characters |
...
{
    "partial_element": "{\"content\":\"Updated text\"}",
...
### Error Codes
      ...
      This interface only supports Schema v2.0 structure. For details, refer to Card JSON 2.0 Structure.
      ...
      400
      300312
      Unable to update element tag
      Unable to update the tag attribute of the component when updating the card entity.
