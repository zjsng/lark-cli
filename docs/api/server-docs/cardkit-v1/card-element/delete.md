...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/cardkit-v1/card-element/delete"
method: "DELETE"
...
When you delete a container class component, the components embedded in the container are deleted together.
...
### Error Codes
      ...
      Failed to delete component. Please check the input parameters according to the error information returned by the interface.
