---
title: "Delete ACL"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-acl/delete"
method: "DELETE"
api_path: "https://open.larksuite.com/open-apis/calendar/v4/calendars/:calendar_id/acls/:acl_id"
service: "calendar-v4"
...
Call this interface to delete a certain access control in the specified calendar with the current identity (application or user), i.e., member permissions.
...
| Required scopes Enable any scope from the list | `calendar:calendar` `calendar:calendar.acl:delete` | ### Request header
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| Authorization | string | Yes | `tenant_access_token` or `user_access_token` **Value format**: "Bearer `access_token`" **Example value**: "Bearer u-7f1bcd13fc57d46bac21793a18e560" How to choose and get access token | ### Path parameters
| Parameter | Type | Description |
| --- | --- | --- |
| `calendar_id` | `string` | The ID of the calendar for which access control needs to be deleted is required. The calendar ID is returned when a shared calendar is created. You can also call the following interfaces to obtain the ID of a calendar. - Query primary calendar information - Query calendar list - Search calendars **Example value**: "larksuite.com_xxxxxxxxxx@group.calendar.larksuite.com" |
| `acl_id` | `string` | Access control ID. The access control ID is returned when access control is created for the calendar. You can also call the get access control list interface to get the access control information within the specified calendar. **Example value**: "user_xxxxxx" | ## Response
