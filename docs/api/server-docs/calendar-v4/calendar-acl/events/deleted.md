---
title: "Remove an ACL"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-acl/events/deleted"
service: "calendar-v4"
...
This event will be triggered when access control is removed from the subscribed calendar.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=calendar&version=v4&resource=calendar.acl&event=deleted)
...
| Facts |  |
| --- | --- |
| Event type | calendar.calendar.acl.deleted_v4 |
