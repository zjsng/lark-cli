---
title: "Subscribe ACL Event"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-acl/subscription"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/calendar/v4/calendars/:calendar_id/acls/subscription"
service: "calendar-v4"
...
# Subscribe to changes in calendar access control

Call this interface in the identity of the user to subscribe to access control change events under the specified calendar.
