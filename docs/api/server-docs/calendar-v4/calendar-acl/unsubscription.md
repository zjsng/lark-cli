---
title: "Unsubscribe ACL Event"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-acl/unsubscription"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/calendar/v4/calendars/:calendar_id/acls/unsubscription"
service: "calendar-v4"
...
# Unsubscribe to changes in calendar access control

Invoke this interface in the user's identity to unsubscribe from access control change events under the specified calendar.

> The user must have access to the calendar.
...
| Required scopes Enable any scope from the list | `calendar:calendar` `calendar:calendar.acl:read` `calendar:calendar:readonly` | ### Request header
