...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/Attendance//task/notify-approval-status-update2"
section: "Attendance"
...
| ------------- | ------ | -- | -------------------------------------------------- |
| approval_id   | string | Yes  | Approval instance ID, which can be obtained using the following APIs: 1) Obtain approval data 2) Add approval results 3) Notify correction approval initiation (under correction situation)                                            |
...
| 400      | 1220005 | No scope       | Please go to the Attendance Admin to check the data scope            |
