---
title: "Employment"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/user/events/created"
service: "contact-v3"
resource: "user"
section: "Contacts"
scopes:
...
This event is triggered when an employee is employed. The "Access Contacts as an app" is a scope of older version and is not recommended to be requested.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=user&event=created)
...
| Facts |  |
| --- | --- |
| Event type | contact.user.created_v3 |
...
| `event` | `\-` | \- |
|   `object` | `user_event` | Event information |
