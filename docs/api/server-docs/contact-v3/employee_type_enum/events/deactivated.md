---
title: "Deactivate Workforce Types"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/employee_type_enum/events/deactivated"
service: "contact-v3"
...
This event is triggered when a workforce type is disabled. The scope of `Access Contacts as an App` is required, and the push mode is `Webhook`.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=employee_type_enum&event=deactivated)

## Event
| Facts |  |
| --- | --- |
| Event type | contact.employee_type_enum.deactivated_v3 |
