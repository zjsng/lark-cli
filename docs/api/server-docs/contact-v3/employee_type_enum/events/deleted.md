---
title: "Delete Workforce Types"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/employee_type_enum/events/deleted"
service: "contact-v3"
...
# Workforce type deleted

This event is triggered when a workforce type is deleted. The scope of `Access Contacts as an App` is required, and the push mode is `Webhook`.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=employee_type_enum&event=deleted)

## Event
| Facts |  |
| --- | --- |
| Event type | contact.employee_type_enum.deleted_v3 |
