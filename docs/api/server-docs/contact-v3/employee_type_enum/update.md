---
title: "Update Workforce Type"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/employee_type_enum/update"
method: "PUT"
...
| --- | --- | --- |
| `enum_id` | `string` | Enum ID **Example value**: "exGeIjow7zIqWMy+ONkFxA contact.v3.type.i18n_content.prop.locale.string.example=$$$zh_cn" | ### Request body
...
| `data` | `\-` | \- |
|   `employee_type_enum` | `employee_type_enum` | Updated workforce type |
