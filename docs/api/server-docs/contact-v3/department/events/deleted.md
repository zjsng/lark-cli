...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/events/deleted"
service: "contact-v3"
resource: "department"
section: "Contacts"
scopes:
...
You can obtain the information of the deleted department by subscribing to this event.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=department&event=deleted)

## Event
| Facts |  |
| --- | --- |
| Event type | contact.department.deleted_v3 |
...
| `event` | `\-` | \- |
|   `object` | `department_event` | Department information |
...
|   `old_object` | `old_department_object` | Department information before the department is deleted |
|     `status` | `department_status` | Department status **Required field scopes (Satisfy any)**: `contact:contact:readonly_as_app` `contact:department.base:readonly` |
|       `is_deleted` | `boolean` | Whether it is deleted |
|     `open_department_id` | `string` | Department open_id | ### Event body example
