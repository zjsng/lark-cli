...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/events/created"
service: "contact-v3"
resource: "department"
section: "Contacts"
scopes:
...
This event is sent to the subscribing app when a department is created in contacts.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=contact&version=v3&resource=department&event=created)

## Event
| Facts |  |
| --- | --- |
| Event type | contact.department.created_v3 |
