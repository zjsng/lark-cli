---
title: "Create A Mailing List Member"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/mailgroup-member/create"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/mail/v1/mailgroups/:mailgroup_id/members"
service: "mail-v1"
...
| `department_id_type` | `string` | No | Type of department ID used in this call **Example value**: open_department_id **Optional values are**:  - `department_id`: Identify the department with the custom department_id - `open_department_id`: Identify the department with open_department_id  | ### Request body
...
| 400 | 1234030 | mailing group member count is over max limit | The maximum number of members in the mail group has been reached. Please delete some before trying again. |
