---
title: "Get A Mail Group Permission Member"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/mailgroup-permission_member/get"
method: "GET"
api_path: "https://open.larksuite.com/open-apis/mail/v1/mailgroups/:mailgroup_id/permission_members/:permission_member_id"
service: "mail-v1"
...
| `permission_member_id` | `string` | Unique identifier of the member in the permissions group **Example value**: "xxxxxxxxxxxxxxx" | ### Query parameters
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
