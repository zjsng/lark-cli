---
title: "Batch Create Mail Group Permission Members"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/mailgroup-permission_member/batch_create"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/mail/v1/mailgroups/:mailgroup_id/permission_members/batch_create"
service: "mail-v1"
...
# Batch creation of mail group permission members

A single request can add multiple permission members to a mail group.
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `items` | `mailgroup.permission_member[]` | No | List of mail group permission members added this time **Data validation rules**: - Length range: `1` ～ `200` |
|   `permission_member_id` | `string` | No | The unique identity of the member in the permission group (do not need to be filled in in the request body) **Example value**: "xxxxxxxxxxxxxxx" |
...
| `data` | `\-` | \- |
|   `items` | `mailgroup.permission_member[]` | List of mail group permission member information after successful addition |
