---
title: "Delete A Mail Group Permission Member"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/mailgroup-permission_member/delete"
method: "DELETE"
...
| `permission_member_id` | `string` | The unique ID of a member in this permission group **Example value**: "xxxxxxxxxxxxxxx" | ## Response
