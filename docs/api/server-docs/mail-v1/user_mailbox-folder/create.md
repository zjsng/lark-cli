...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-folder/create"
method: "POST"
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `name` | `string` | Yes | Name **Example value**: "newsletter" **Data validation rules**: - Length range: `1` ～ `250` characters |
| `parent_folder_id` | `string` | Yes | Parent folder ID, where a value of 0 indicates the root folder. The method for obtaining ID is shown in List Email Folders **Example value**: "725627422334644" | ### Request body example
...
|     `folder_type` | `int` | Folder type **Optional values are**:  - `1`: System Folder - `2`: User folder  | ### Response body example
