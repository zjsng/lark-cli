---
title: "Update Auto FIlter"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/mail-v1/user_mailbox-rule/update"
method: "PUT"
api_path: "https://open.larksuite.com/open-apis/mail/v1/user_mailboxes/:user_mailbox_id/rules/:rule_id"
service: "mail-v1"
...
| `rule_id` | `string` | Rule ID. The method for obtaining ID is shown in List Auto Filters **Example value**: "123123123" | ### Request body
...
| `name` | `string` | Yes | Name **Example value**: "将李三的邮件标记为垃圾邮件" **Data validation rules**: - Length range: `1` ～ `255` characters |
