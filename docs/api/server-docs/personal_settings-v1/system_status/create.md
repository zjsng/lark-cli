---
title: "Create system status"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/personal_settings-v1/system_status/create"
method: "POST"
...
Create a system status with a tenant-wide dimension.

> Notice:
> - The data to be operated is tenant dimension data, please operate with care.
> - Create up to 10 system states per tenant.
...
|     `ja_jp` | `string` | No | Japanese name **Example value**: "申請が承認されると、このステータスが優先的に表示されます" | ### Request body example
...
| 400 | 2005004 | The number of tenant system status exceeds limit | The number of tenant dimension system states exceeds 10. |
