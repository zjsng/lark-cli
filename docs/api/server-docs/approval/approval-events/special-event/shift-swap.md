---
title: "Shift swap"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uIDO24iM4YjLygjN/event/shift-change"
section: "Approval"
updated: "1676430240000"
---

# Shift swap
> To understand the usage scenes and configuration process of event subscription, click Event subscription overview.

This event is triggered after the shift swap application is approved. 
...
```json
{
     ...
     "event": {
         ...
         "shift_time": "2018-12-01 12:00:00",    // Original shift  
         "return_time": "2018-12-02 12:00:00",   // New shift  
         "shift_reason": "xxx"     // Reason
    }
}
```
