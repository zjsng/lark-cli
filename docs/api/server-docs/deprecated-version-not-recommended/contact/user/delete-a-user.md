---
title: "Delete a User"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUzNz4SN3MjL1czM"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/contact/v1/user/delete"
section: "Deprecated Version (Not Recommended)"
updated: "1646999063000"
---
...
This API is used to delete a user from Contacts. 

The application should apply for `update contacts` and `access contacts by application identity` permissions to invoke this API. Contacts permission for this user and the user’s departments is required to invoke this API. To invoke this API, the request header must specify the tenant_access_token.  Marketplace apps do not have permission to invoke this API.
...
|--|-----|--|----|
|open_id|String|Yes|User’s open ID|
### Request body example
```json
{
    "employee_id":"2f623a9b"
