---
title: "Obtain Group List to Which User Belongs"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uQzMwUjL0MDM14CNzATN"
method: "GET"
api_path: "https://open.larksuite.com/open-apis/user/v4/group_list?page_size=2&page_token=6592161138799017988"
section: "Deprecated Version (Not Recommended)"
updated: "1626158302000"
---

# Obtain All Groups To Which User Belongs
Obtain all groups to which user belongs. 
...
page_token | string | No | Pagination markup. It is not filled in the first request, indicating traversal from the beginning; when there will be more groups, the new page_token will be returned at the same time, and the next traversal can use the page_token to get more groups.||6592161138799017988| ## Response
