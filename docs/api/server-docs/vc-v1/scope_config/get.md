---
title: "Query room configuration"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/scope_config/get"
method: "GET"
...
| `data` | `\-` | \- |
|   `current_config` | `scope_config` | Configuration of current node |
|     `scope_type` | `int` | Scope type **Optional values are**:  - `1`: Room level - `2`: Room  |
|     `scope_id` | `string` | Scope ID |
|     `scope_config` | `room_config` | Room configuration of a scope |
...
|   `origin_configs` | `scope_config[]` | Configurations of all parent nodes of current node |
|     `scope_type` | `int` | Scope type **Optional values are**:  - `1`: Room level - `2`: Room  |
|     `scope_id` | `string` | Scope ID |
|     `scope_config` | `room_config` | Room configuration of a scope |
|       `room_background` | `string` | Lark room background |
