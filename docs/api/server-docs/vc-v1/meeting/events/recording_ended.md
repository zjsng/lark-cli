...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/events/recording_ended"
service: "vc-v1"
resource: "meeting"
...
Occurs at the end of recording [This event occurs for meetings booked by Open API only]{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=meeting&event=recording_ended)

## Event
| Facts |  |
| --- | --- |
| Event type | vc.meeting.recording_ended_v1 |
