...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/kickout"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/vc/v1/meetings/:meeting_id/kickout"
service: "vc-v1"
resource: "meeting"
...
| --- | --- | --- |
| `meeting_id` | `string` | Meeting ID **Example value**: "6911188411932033028" | ### Query parameters
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `kickout_users` | `meeting_user[]` | Yes | List of users to be removed |
...
| `data` | `\-` | \- |
|   `kickout_results` | `meeting_participant_result[]` | Removal result |
|     `id` | `string` | User ID |
...
|     `result` | `int` | Removal result **Optional values are**:  - `1`: Remove succeeded - `2`: Remove failed  | ### Response body example
