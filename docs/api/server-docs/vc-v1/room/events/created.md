...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room/events/created"
service: "vc-v1"
resource: "room"
...
This event is triggered when a meeting room is created.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=vc&version=v1&resource=room&event=created)

## Event
| Facts |  |
| --- | --- |
| Event type | vc.room.created_v1 |
