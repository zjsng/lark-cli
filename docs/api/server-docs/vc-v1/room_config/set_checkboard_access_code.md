---
title: "set_checkboard_access_code"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/room_config/set_checkboard_access_code"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/vc/v1/room_configs/set_checkboard_access_code"
service: "vc-v1"
...
# Create a checkboard access code

Create a scoped checkboard access code
...
| `country_id` | `string` | No | This parameter is required when country ID scope is 2, 3 **Example value**: "1" |
| `district_id` | `string` | No | This parameter is required when the city ID scope is 3 **Example value**: "2" |
| `building_id` | `string` | No | This parameter is required when the building ID scope is 4 and 5 **Example value**: "3" |
| `floor_name` | `string` | No | This parameter is required when the floor scope is 5 **Example value**: "4" |
| `room_id` | `string` | No | This parameter is required when the meeting room ID scope is 6 **Example value**: "67687262867363" |
| `valid_day` | `int` | Yes | valid date **Example value**: 1 **Optional values are**:  - `1`: 1 day - `7`: 7 days - `30`: 30 days  | ### Request body example
