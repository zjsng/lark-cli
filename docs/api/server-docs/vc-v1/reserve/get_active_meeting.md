---
title: "Obtain an active meeting"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/reserve/get_active_meeting"
method: "GET"
api_path: "https://open.larksuite.com/open-apis/vc/v1/reserves/:reserve_id/get_active_meeting"
service: "vc-v1"
resource: "reserve"
...
Obtains a scheduled meeting that is currently active.

> You can only obtain your own active meetings that are scheduled (Only one meeting in progress is allowed for each schedule).
...
| --- | --- | --- |
| `reserve_id` | `string` | Schedule ID (unique identifier for a schedule) **Example value**: "6911188411932033028" | ### Query parameters
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `with_participants` | `boolean` | No | Whether the participant list is required. The default value is false. **Example value**: false |
