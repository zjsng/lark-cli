---
title: "Get user migration status in batches"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/security_and_compliance-v1/user_migration/search"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/security_and_compliance/v1/user_migrations/search"
...
Pass in a list of user IDs to get user migration status in batches.
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `user_ids` | `string[]` | Yes | List of user IDs. **Example value**: abcdefghi **Data validation rules**: - Length range: `1` ～ `500` | ### Request body example
...
| `data` | `\-` | \- |
|   `items` | `user_migration[]` | List of user migration records. |
