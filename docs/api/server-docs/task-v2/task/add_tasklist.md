...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/add_tasklist"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/task/v2/tasks/:task_guid/add_tasklist"
service: "task-v2"
resource: "task"
section: "Tasks v2"
...
scopes:
  - "task:task:write"
updated: "1699521586000"
---

# Add Task to Tasklist

Add a task to a tasklist. Returns the details of the task, including all tasklist information where the task belongs to.

If the task is already in the manifest, the interface will return success.

> The calling identity needs to have both the edit permission of the task and the edit permission of the tasklist. Please refer to the "How are Tasks Authorized?" section in Task Features Overview and "How are tasklist authorized?" section in Tasklist Features Overview.
...
| --- | --- | --- |
| `task_guid` | `string` | GUID of task to add to tasklist **Example value**: "d300a75f-c56a-4be9-80d1-e47653028ceb" | ### Query parameters
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `tasklist_guid` | `string` | Yes | Tasklist GUID to be added into **Example value**: "d300a75f-c56a-4be9-80d1-e47653028ceb" **Data validation rules**: - Maximum length: `100` characters |
| `section_guid` | `string` | No | The section GUID of tasklist to add, if not filled in, default section GUID will be used. **Example value**: "d300a75f-c56a-4be9-80d1-e47653028ceb" | ### Request body example
...
|     `repeat_rule` | `string` | If the task is a recurring task, return the repeat rule. |
...
| --- | --- | --- | --- |
| 400 | 1470400 | The request parameter is wrong, such as the GUID format of the task is illegal. | The reason for the error is shown in the returned msg prompt. |
| 500 | 1470500 | Server error. | Try retrying the call. If it continues to fail, please contact support for feedback. |
| 404 | 1470404 | The task or list does not exist or has been deleted. | Verify that the tasks and lists you want to operate on exist or have been deleted. |
| 403 | 1470403 | Missing permission to add tasks to the list. | Check if the calling identity has edit permissions for both the task and the tasklist. Please refer to the "How are Tasks Authorized?" section in Task Features Overview and "How are tasklist authorized?" section in Tasklist Features Overview. |
