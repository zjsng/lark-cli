---
title: "Remove task reminders"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/task-v2/task/remove_reminders"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/task/v2/tasks/:task_guid/remove_reminders"
service: "task-v2"
resource: "task"
section: "Tasks v2"
...
scopes:
  - "task:task:write"
updated: "1699521598000"
---

# Remove Task Reminder

Remove a reminder from the task.

If the reminder to be removed does not exist in the first place, this interface will directly return success.

> Requires editing permission for the task. See How is the task authenticated?.
...
| --- | --- | --- |
| `task_guid` | `string` | GUID of task from which reminder is removed. **Example value**: "d300a75f-c56a-4be9-80d1-e47653028ceb" **Data validation rules**: - Maximum length: `100` characters | ### Query parameters
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `reminder_ids` | `string[]` | Yes | IDs of reminders to be removed. **Example value**: ["7202449098622894100"] | ### Request body example
...
| `data` | `\-` | \- |
|   `task` | `task` | Reminder list for removed tasks |
|     `guid` | `string` | GUID of task |
...
|     `repeat_rule` | `string` | Task repetition rule |
...
| --- | --- | --- | --- |
| 400 | 1470400 | The request parameter is incorrect, such as the reminder_id value passed in is invalid. | The reason for the error is shown in the returned ms. |
...
| 403 | 1470403 | Missing task edit permission. | Check if the calling identity has edit permissions for the task. See How is the task authenticated? |
