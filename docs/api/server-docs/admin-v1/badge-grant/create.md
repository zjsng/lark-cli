---
title: "Create a grant list"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/admin-v1/badge-grant/create"
method: "POST"
...
Through this API, a list of grants can be created for a specific badge, and up to 1,000 grant lists can be created under one badge.
...
| --- | --- | --- |
| `badge_id` | `string` | Badge ID **Example value**: "m_DjMzaK" **Data validation rules**: - Length range: `1` ～ `64` characters | ### Query parameters
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
...
| `data` | `\-` | \- |
|   `grant` | `grant` | Information on the grant list |
...
| 400 | 1051204 | reach the count limit of grant | The number of grant lists has reached the upper limit |
