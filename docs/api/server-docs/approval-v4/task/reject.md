---
title: "Refuse to approve tasks"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/reject"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/approval/v4/tasks/reject"
service: "approval-v4"
resource: "task"
section: "Approval"
scopes:
...
| `task_id` | `string` | Yes | Task ID, approval instance details task_list id **Example value**: "12345" | ### Request body example
