---
title: "Agree to approval task"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/approve"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/approval/v4/tasks/approve"
service: "approval-v4"
resource: "task"
section: "Approval"
scopes:
...
| `form` | `string` | No | JSON array, Widget value(Will affect the process, if some widget is missing) **Example value**: "[{\"id\":\"111\", \"type\": \"input\", \"value\":\"test\"}]" | ### Request body example
