---
title: "Transfer the approval task"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/task/transfer"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/approval/v4/tasks/transfer"
service: "approval-v4"
resource: "task"
section: "Approval"
scopes:
...
| `instance_code` | `string` | Yes | Approval instance code **Example value**: "81D31358-93AF-92D6-7425-01A5D67C4E71" |
...
| `transfer_user_id` | `string` | Yes | Fill in the unique ID of the transferred person according to the user_id_type **Example value**: "f4ip317q" |
| `task_id` | `string` | Yes | Task ID, review instance details task_list id **Example value**: "12345" | ### Request body example
