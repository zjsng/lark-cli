---
title: "Revoke approval instances"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/cancel"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/approval/v4/instances/cancel"
service: "approval-v4"
resource: "instance"
section: "Approval"
scopes:
...
| `user_id` | `string` | Yes | Operation user, fill in according to user_id_type **Example value**: "f7cb567e" | ### Request body example
