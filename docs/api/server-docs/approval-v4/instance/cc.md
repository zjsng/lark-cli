---
title: "Notify someone of approval instances"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/instance/cc"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/approval/v4/instances/cc"
service: "approval-v4"
resource: "instance"
section: "Approval"
scopes:
...
| `instance_code` | `string` | Yes | Approval instance code **Example value**: "7C468A54-8745-2245-9675-08B7C63E7A85" |
| `user_id` | `string` | Yes | Fill in the user id of the person who initiated the cc according to the user_id_type **Example value**: "f7cb567e" |
| `cc_user_ids` | `string[]` | Yes | According to the user_id_type, fill in the user id list of the copied person **Example value**: f7cb567e |
| `comment` | `string` | No | CC comment **Example value**: "ok" | ### Request body example
