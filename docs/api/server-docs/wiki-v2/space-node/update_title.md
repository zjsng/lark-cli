---
title: "Update title"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space-node/update_title"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/wiki/v2/spaces/:space_id/nodes/:node_token/update_title"
service: "wiki-v2"
resource: "space-node"
section: "Docs"
scopes:
...
This interface is used for updating node title.

> This interface currently only supports doc, docx and shortcuts.
...
| --- | --- | --- |
| `space_id` | `string` | Space ID **Example value**: "6946843325487912356" |
| `node_token` | `string` | Node Token **Example value**: "wikcnKQ1k3pcuo5uSK4t8Vabcef" | ### Request body

| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `title` | `string` | Yes | New title of the node **Example value**: "new title" | ### Request body example
