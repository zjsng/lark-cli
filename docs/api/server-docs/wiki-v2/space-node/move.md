---
title: "Move node"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space-node/move"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/wiki/v2/spaces/:space_id/nodes/:node_token/move"
service: "wiki-v2"
resource: "space-node"
section: "Docs"
scopes:
...
This method is used to move nodes within the Wiki and supports movement across the Wiki space

> Wiki permission requirements:
> - Node Edit Permission
> - Original Parent Container Edit Permission
...
| `node_token` | `string` | Node tokens to migrate **Example value**: "wikbcd6ydSUyOEzbdlt1BfpA5Yc" | ### Request body

| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `target_parent_token` | `string` | No | Moved to parent token **Example value**: "wikbcd6ydSUyOEzbdlt1BfpA5Yc" |
| `target_space_id` | `string` | No | Moved to Wiki space **Example value**: "7008061636015512345" | ### Request body example
...
| `data` | `\-` | \- |
|   `node` | `node` | Node information after moving |
