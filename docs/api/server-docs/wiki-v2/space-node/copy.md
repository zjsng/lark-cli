---
title: "Create a node copy"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space-node/copy"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/wiki/v2/spaces/:space_id/nodes/:node_token/copy"
service: "wiki-v2"
resource: "space-node"
section: "Docs"
scopes:
...
This interface is used for creating a copy of a node to a specified location.
...
| --- | --- | --- |
| `space_id` | `string` | Wiki Workspace id **Example value**: "6946843325487912356" |
| `node_token` | `string` | Node token **Example value**: "wikcnKQ1k3pcuo5uSK4t8Vabcef" | ### Request body

| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `target_parent_token` | `string` | No | Target parent node token **Example value**: "wikcnKQ1k3pcuo5uSK4t8Vabcef" |
| `target_space_id` | `string` | No | Target Wiki Workspace id **Example value**: "6946843325487906839" |
| `title` | `string` | No | Copied new title. If blank, the new title is empty. If not, the original node title is used. **Example value**: "New title" | ### Request body example

{
    "target_parent_token": "wikcnKQ1k3pcuo5uSK4t8Vabcef",
    "target_space_id": "6946843325487906839",
    "title": "New title"
}
