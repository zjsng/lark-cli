---
title: "Delete Wiki space members"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space-member/delete"
method: "DELETE"
api_path: "https://open.larksuite.com/open-apis/wiki/v2/spaces/:space_id/members/:member_id"
service: "wiki-v2"
...
This method is used to delete Wiki space members.

- Public Wiki space (visibility is public) is visible to all users of the tenant, so removing members is not supported, but admins can be removed. 
  
 - Personal Wiki space (type is person) is a personally managed Wiki space and does not support deleting admins. But members can be deleted.
...
| --- | --- | --- |
| `space_id` | `string` | Wiki space id **Example value**: "7008061636015554580" |
| `member_id` | `string` | Member id **Example value**: "g64fb7g7" | ### Request body
