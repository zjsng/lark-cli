---
title: "Update Wiki space settings"
url: "https://open.larksuite.com/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space-setting/update"
method: "PUT"
api_path: "https://open.larksuite.com/open-apis/wiki/v2/spaces/:space_id/setting"
service: "wiki-v2"
...
Update the public settings of the Wiki space according to space_id
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `create_setting` | `string` | No | Who can create space level page: "admin_and_member" = admin and member "admin" - admin only **Example value**: "admin/admin_and_member" |
| `security_setting` | `string` | No | Readable user can create copy/print/export/copy: "allow" -allow "not_allow" -not allowed **Example value**: "allow/not_allow" |
| `comment_setting` | `string` | No | Readable user can comment: "allow" -allow "not_allow" -not allowed **Example value**: "allow/not_allow" | ### Request body example
...
| `data` | `\-` | \- |
|   `setting` | `setting` | Knowledge space settings |
|     `create_setting` | `string` | Who can create space level page: "admin_and_member" = admin and member "admin" - admin only |
|     `security_setting` | `string` | Readable user can create copy/print/export/copy: "allow" -allow "not_allow" -not allowed |
|     `comment_setting` | `string` | Readable user can comment: "allow" -allow "not_allow" -not allowed | ### Response body example
