---
title: "Get User OKR List"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/okr-v1/user-okr/list"
method: "GET"
api_path: "https://open.larksuite.com/open-apis/okr/v1/users/:user_id/okrs"
service: "okr-v1"
resource: "user-okr"
section: "OKR"
scopes:
...
# Get the user's OKR list

Get OKR list based on user id
...
| --- | --- | --- |
| `user_id` | `string` | Target user id **Example value**: "ou-xxxx" | ### Query parameters
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
...
| `offset` | `string` | Yes | Offset of request list, offset > = 0, request Query **Example value**: "0" |
| `limit` | `string` | Yes | The length of the request list, 0 
      Parameter | Type | Description |
| --- | --- | --- |
| `code` | `int` | Error codes, fail if not zero |
| `msg` | `string` | Error descriptions |
| `data` | `\-` | \- |
|   `total` | `int` | Total number of OKR cycles |
...
|         `status` | `string` | Objective progress status |
