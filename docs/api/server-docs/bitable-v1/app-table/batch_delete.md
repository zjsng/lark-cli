---
title: "Batch delete table"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table/batch_delete"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/tables/batch_delete"
service: "bitable-v1"
resource: "app-table"
section: "Docs"
...
| --- | --- | --- |
| `app_token` | `string` | Base unique device identifier app_token description **Example value**: "appbcbWCzen6D8dezhoCH2RpMAh" **Data validation rules**: - Minimum length: `1` characters | ### Request body

| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `table_ids` | `string[]` | No | Base data table unique device identifier,Currently supports up to 50 data tables in one operationtable_id description **Example value**: ["tbl1TkhyTWDkSoZ3"] | ### Request body example
