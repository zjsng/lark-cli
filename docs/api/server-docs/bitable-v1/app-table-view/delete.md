---
title: "Delete View"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-view/delete"
method: "DELETE"
...
| `view_id` | `string` | View Id **Example value**: "VIVWTpR1urY" | ## Response
