---
title: "Get View"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-view/get"
method: "GET"
...
| --- | --- | --- |
| `app_token` | `string` | Base app token **Example value**: "bascnCMII2ORej2RItqpZZUNMIe" **Data validation rules**: - Minimum length: `1` characters |
| `table_id` | `string` | Table ID **Example value**: "tblsRc9GRRXKqhvW" |
| `view_id` | `string` | View ID **Example value**: "vewTpR1urY" | ## Response
