---
title: "Add View"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-view/create"
method: "POST"
...
| `table_id` | `string` | Table id **Example value**: "TblsRc9GRRXKqhvW" | ### Request body

| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `view_name` | `string` | Yes | View name **Example value**: "Gantt View 1" |
| `view_type` | `string` | No | View type **Example value**: "gantt" **Optional values are**:  - `grid`: Grid view - `kanban`: Kanban view - `gallery`: Gallery view - `gantt`: Gantt view - `form`: Form view  | ### Request body example
...
|     `view_type` | `string` | View type | ### Response body example
