---
title: "List form"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-form/get"
method: "GET"
...
| --- | --- | --- |
| `app_token` | `string` | base app token **Example value**: "bascnv1jIEppJdTCn3jOosabcef" |
| `table_id` | `string` | table id **Example value**: "tblz8nadEUdxNMt5" |
| `form_id` | `string` | form id **Example value**: "vew6oMbAa4" | ## Response
...

{
    ...
    "data": {
        "form": {
            ...
            "shared": true,
            "shared_url": "https://example.larksuite.com/share/base/shrcnCy1KAlpahNotmhRn1abcde (The update API does not support this parameter)",
