---
title: "Delete member"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role-member/delete"
method: "DELETE"
api_path: "https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/roles/:role_id/members/:member_id"
service: "bitable-v1"
...
| `role_id` | `string` | Role id **Example value**: "roljRpwIUt" |
| `member_id` | `string` | Member id **Example value**: "ou_7dab8a3d3cdcc9da365777c7ad53uew2" | ### Query parameters
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `member_id_type` | `string` | No | Member id type **Example value**: open_id **Optional values are**:  - `open_id`: open_id - `union_id`: union_id - `user_id`: user_id - `chat_id`: chat_id - `department_id`: department_id - `open_department_id`: open_department_id  **Default value**: `open_id` | ## Response
