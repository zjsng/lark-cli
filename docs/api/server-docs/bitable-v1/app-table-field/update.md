---
title: "Update field"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-field/update"
method: "PUT"
...
| Required scopes Enable any scope from the list | `bitable:app` base:field:update | ### Request header
...
| `field_id` | `string` | field id **Example value**: "fldPTb0U2y" | ### Request body
