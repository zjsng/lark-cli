---
title: "Copy dashboards"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-dashboard/copy"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/bitable/v1/apps/:app_token/dashboards/:block_id/copy"
service: "bitable-v1"
...
| --- | --- | --- |
| `app_token` | `string` | Base App Token **Example value**: "basbcldP5xZeskcHDFZQfeToydb" |
| `block_id` | `string` | Base block_id **Example value**: "blkEsvEEaNllY2UV" | ### Request body

| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `name` | `string` | Yes | Dashboard Name **Example value**: "Dashboard" | ### Request body example
...
|   `name` | `string` | Block name | ### Response body example
