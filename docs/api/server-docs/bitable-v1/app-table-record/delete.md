...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-table-record/delete"
method: "DELETE"
...
| `table_id` | `string` | table_id **Example value**: "tblsRc9GRRXKqhvW" |
| `record_id` | `string` | record_id **Example value**: "recpCsf4ME" | ### Query parameters
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `ignore_consistency_check` | `boolean` | No | ignore consistency check **Example value**: false | ## Response
