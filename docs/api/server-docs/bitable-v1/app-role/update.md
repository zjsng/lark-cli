---
title: "Update role"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role/update"
method: "PUT"
...
> The update of the role is an incremental update,  where only the passed fields are updated, and the fields that are not passed are not updated
...
| `role_id` | `string` | Role id **Example value**: "roljRpwIUt" | ### Request body
