...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/historic-version/docs/sheets/datavalidation/delete-datavalidation"
method: "DELETE"
...
scopes:
  - "drive:drive"
  - "sheets:spreadsheet"
updated: "1755579373000"
---

# ~~Delete drop-down settings~~

**Note: This API will become unavailable starting September 20, 2025. Please update your app to use the latest API Delete drop-down settings.**
...
|  ∟dataValidationIds|array|Yes|Specifies the dataValidationIds to delete| ### Request body example
