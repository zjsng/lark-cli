...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/application-v6/application-app_version/get"
method: "GET"
...
| --- | --- | --- |
| `app_id` | `string` | App's app_id. To query the version information of other apps, you must request the Obtain app version information scope. To only query the version information of this app, enter "me" or the app_id. **Example value**: "cli_9f3ca975326b501b" |
...
| `data` | `\-` | \- |
|   `app_version` | `application.app_version` | App version information |
...
|           `group_ids` | `string[]` | Invisibility list of IDs of groups to which the app is visible | ### Response body example
