---
title: "App Created"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/application-v6/application/events/created"
...
updated: "1646720029000"
---

# App Created

Occured when a new application is created in the enterprise{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=application&version=v6&resource=application&event=created)

## Event
| Facts |  |
| --- | --- |
| Event type | application.application.created_v6 |
...
| ∟ `avatar` | `string` | App avatar url |
| ∟ `app_scene_type` | `int` | App scene type |
| ∟ `primary_language` | `string` | App primary language | ### Event body example
