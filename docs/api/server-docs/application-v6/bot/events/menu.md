---
title: "Bot Menu Event"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/application-v6/bot/events/menu"
...
updated: "1691567339000"
---

# Bot Menu Event

This event is triggered when the user clicks bot menu{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=application&version=v6&resource=bot&event=menu)

## Event
| Facts |  |
| --- | --- |
| Event type | application.bot.menu_v6 |
| Supported app types | custom |
| Required scopes | None |
| Required field scopes | > The response body of the API contains the following sensitive fields, and they will be returned only after corresponding scopes are added. If you do not need the fields, it is not recommended that you request the scopes. `application:application.bot.operator_name:readonly` `contact:user.employee_id:readonly` |
...
| `event` | `\-` | \- |
|   `operator` | `operator` | Operator information |
|     `operator_name` | `string` | Operator name **Data validation rules**: - Length range: `1` ～ `100` characters **Required field scopes**: `application:application.bot.operator_name:readonly` |
...
|   `event_key` | `string` | Unique ID of the menu event **Data validation rules**: - Length range: `1` ～ `30` characters |
|   `timestamp` | `string` | The timestamp of user click menu **Data validation rules**: - Length range: `1` ～ `30` characters | ### Event body example
