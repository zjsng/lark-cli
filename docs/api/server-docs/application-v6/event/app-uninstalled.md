...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/application-v6/event/app-uninstalled"
service: "application-v6"
resource: "event"
section: "App Information"
updated: "1646720042000"
---

# App uninstalled
> To understand the scenarios and configuration process of event subscription, see Event subscription overview.

- This event is not available to custom apps.

- The event is pushed when a company is disbanded. Store app developers can delete accounts and clear data after receiving this event.
...
{ 
    ...
    "event": {
        "app_id": "cli_xxx", // ID of the app uninstalled
        "tenant_key": "xxx",  // ID of company that uninstalled the app
        "type": "app_uninstalled"  // Event type
     }
}
```
