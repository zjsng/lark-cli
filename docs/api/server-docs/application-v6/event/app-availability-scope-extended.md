---
title: "App availability scope extended"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/application-v6/event/app-availability-scope-extended"
...
# App availability range expanded
> To understand the scenarios and configuration process of event subscription, see Event subscription overview.

This event is pushed only when a user in the company obtains app availability by adopting the "installation by ordinary members" method.

- Subscription condition: Store app
...
```json
{
    "schema": "2.0",
    "header": {
        "event_id": "a069a9c71bd8f82dd1fc5a2fae777842",// Unique identifier of the event
        "token": "l802sPhp2r1AMSPDTaJc5eYZOEnKyp",// Verification token 
        "create_time": "1615813148349",//  Time when the event was sent
        "event_type": "application.application.visibility.added_v6", // Event type 
        "tenant_key": "2d3aa0bc8d8f575d", // Company identifier 
        "app_id": "cli_9dbb2dd6f5e0d104" // App ID
    },
    "event": {
        "source": 1, // Event source. The value of 1 indicates that app visibility is expanded owing to installation by an ordinary member.
        "users": [
            {
                "user_id": { // ID of the user that installed the app
