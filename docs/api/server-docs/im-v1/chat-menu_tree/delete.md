---
title: "Delete chat menu"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-menu_tree/delete"
method: "DELETE"
...
This interface is used to delete the added chat menu in the chat.
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `chat_menu_top_level_ids` | `string[]` | Yes | The top level menu ID to be deleted in the group. Get the menus through the Get Chat Menu. **Example value**: ["6936075528890826780"] | ### Request body example
...
| `data` | `\-` | \- |
|   `menu_tree` | `chat.menu_tree` | Existing menu in the chat. |
