---
title: "Message read"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/events/message_read"
service: "im-v1"
resource: "message"
section: "Messaging"
scopes:
...
This event is triggered when a user reads a private chat message sent by the bot.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=message&event=message_read)

> Notes:
> - Bot ability must be enabled.
> - You must subscribe to the Message read event under the Instant Messaging category.
...
|   `message_id_list` | `string[]` | Message list | ### Event body example
