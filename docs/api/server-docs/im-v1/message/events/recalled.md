...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message/events/recalled"
service: "im-v1"
resource: "message"
section: "Messaging"
scopes:
...
Message is recalled trigger this event.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=message&event=recalled)

## Event
| Facts |  |
| --- | --- |
| Event type | im.message.recalled_v1 |
...
|   `recall_time` | `string` | recall timestamp |
|   `recall_type` | `string` | recalled type **Optional values are**:  - `message_owner`: message owner recall - `group_owner`: group owner recall - `group_manager`: group manager recall - `enterprise_manager`: enterprise admin recall  | ### Event body example
