---
title: "Bots removed from a group"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-member-bot/events/deleted"
service: "im-v1"
...
This event is triggered when a bot is removed from a group chat.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.member.bot&event=deleted)

> Notes:
> - The bot ability needs to be enabled.
> - The Bots removed from a group event under the Messenger category needs to be subscribed to.
> - The event is pushed to the bots removed from a group.

## Event
| Facts |  |
| --- | --- |
| Event type | im.chat.member.bot.deleted_v1 |
