---
title: "Bots added to a group"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-member-bot/events/added"
service: "im-v1"
resource: "chat-member-bot"
section: "Group Chat"
scopes:
  - "im:chat"
...
This event is triggered when bots are added to a group chat by users.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.member.bot&event=added)

> Notes:
> - The bot ability needs to be enabled.
> - The Bots added to a group event under the Messenger category needs to be subscribed to.
> - The event is pushed to the bots added to a group.
> - This event is not triggered when bots are invited to a group by bots.

## Event
| Facts |  |
| --- | --- |
| Event type | im.chat.member.bot.added_v1 |
| Supported app types | custom,isv |
| Required scopes Enable any scope from the list | `im:chat` `im:chat.members:bot_access` `im:chat:readonly` |
