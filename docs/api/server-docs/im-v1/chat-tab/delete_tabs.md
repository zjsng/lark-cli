...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/delete_tabs"
method: "DELETE"
api_path: "https://open.larksuite.com/open-apis/im/v1/chats/:chat_id/chat_tabs/delete_tabs"
service: "im-v1"
resource: "chat-tab"
section: "Group Chat"
...
> - Only allow to delete group tabs of type `doc` and `url`.
> - Only the group owner and group admins can remove chat tabs when the setting Only the group owner and admins can manage tabs is turned on.
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `tab_ids` | `string[]` | Yes | Chat tag ID list. Tab ID can be found in Add Chat Tab and Pull Chat Tab return value. **Example value**: ["6936075528890826780"] | ### Request body example
...
| 400 | 232049 | Operate chat tab unsupported chat type. | Update or delete operations only support tabs of doc or url type. |
| 400 | 232050 | The operator does not have chat tab, chat menu, chat widget manage permission | The requested group type does not support chat tabs. |
