---
title: "Update chat tab"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/update_tabs"
method: "POST"
api_path: "https://open.larksuite.com/open-apis/im/v1/chats/:chat_id/chat_tabs/update_tabs"
service: "im-v1"
resource: "chat-tab"
section: "Group Chat"
...
> - Only allow to update group tabs of type `doc` and `url`.
> - Only the group owner and group admins can update chat tabs when the setting Only the group owner and admins can manage tabs is turned on.
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| `chat_tabs` | `chat.tab[]` | No | Chat tags |
|   `tab_id` | `string` | No | Tab ID **Example value**: "7101214603622940671" |
|   `tab_name` | `string` | No | Tab name **Note**: The group tab name does not exceed 30 characters. **Example value**: "doc" |
...
| 400 | 232049 | The chat tab content is illegal. | Update or delete operations only support tabs of doc or url type. |
