---
title: "Users join a group"
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-member-user/events/added"
service: "im-v1"
...
This event is triggered when a new user joins a group (including topic group).{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=chat.member.user&event=added)

> Notes:
> - The bot ability needs to be enabled.
> - The Users join a group/Add users to a group event under the Messenger category needs to be subscribed to.
> - The event is pushed to bots who have subscribed to this event in the group.

## Event
| Facts |  |
| --- | --- |
| Event type | im.chat.member.user.added_v1 |
...
|   `users` | `chat.member.user[]` | List of users added to a group |
