...
url: "https://open.larksuite.com/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/message-reaction/events/created"
service: "im-v1"
...
This event is triggered when a reaction for a message is added.{Usage Examples}(url=/api/tools/api_explore/api_explore_config?project=im&version=v1&resource=message.reaction&event=created)

> Notes:
> - Bot ability must be enabled.
> - To receive the pushed messages, you must have the scope Read messages in private and group chats or Read and send messages in private and group chats and subscribe to reaction.created events under the Messenger category.
> - A bot can only receive reaction addition events for messages in the group chat where the bot resides.

## Event
| Facts |  |
| --- | --- |
| Event type | im.message.reaction.created_v1 |
